...
import { ref } from "vue"
import useFavorStore from "@/stores/favor"
...
// 获取数据
const useFavor = useFavorStore()
useFavor.fetchFavorList()
useFavor.fetchHistoryList()
const { favorList, historyList } = storeToRefs(useFavor)
